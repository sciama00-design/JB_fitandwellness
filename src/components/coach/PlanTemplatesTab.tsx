  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-white">Modelli Schede</h2>
          <p className="text-slate-400 mt-1 font-medium">Gestisci i tuoi modelli di allenamento riutilizzabili.</p>
        </div>

        <Link 
          to="/coach/templates/new" 
          className="group relative px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl font-bold transition-all duration-300 shadow-xl shadow-emerald-500/20 hover:scale-105 active:scale-95 flex items-center gap-2 overflow-hidden text-sm"
        >
      ...
      {templates?.length === 0 ? (
        <div className="text-center py-20 glass rounded-3xl border-dashed border-2 border-slate-800">
          ...
          <p className="text-slate-400">Nessuna scheda trovata. Crea la tua prima scheda!</p>
        </div>
      ) : (
